...
tracking = read.csv("week8_cut_by_frame_clean.csv")
force = read.csv("raw_forces_week8.csv")
partitioned = read.csv("partitioned_forces8.csv")
...
write.csv(features_all3,'features_all_8.csv')
```
